        ...
        <div className="githubProfile">
          ...
          <div className="profileDesc">
            ...
            <span className="profileDescItem">
              Javascript • React • Node.js <br />I solve problems with my
              knowledge
            </span>
            <span className="profileDescFooter">
              <a href="https://github.com/iamdevmarcos/" target="_blank">
                Follow me on GitHub
              </a>
            </span>
          </div>
      ...
      {/* {name === "github_folder" && (
        <div className="githubFolder">
          ...
          <p className="githubFolderTitle">
            You can see the source code <br /> by clicking below.
          </p>
          <p className="githubFolderFeedBack">
            I will be very happy if you give your feedback on this project 😄
          </p>
